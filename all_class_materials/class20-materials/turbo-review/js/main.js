...
let positiveAffirm = "You are beautiful today"
console.log(`Again: ${positiveAffirm.repeat(24)}`)
...
// or spock) and determines if they won a game of rock paper scissors against a bot using the above function
