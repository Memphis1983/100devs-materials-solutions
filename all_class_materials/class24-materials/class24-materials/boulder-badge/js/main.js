...
// and evolves at level 7, and weedle which is at level 1 and evolves at level 7.
 ...
 //(rare candies increase your level by one). Finally, create a fourth variable named totalCandies that
...
function underPokemonLegue(numOfPokemon) {
  for (let i = 0; i < numOfPokemon; i++) {
    console.log("Pikachu, I choose you!")
  }
}

underPokemonLegue(10)
